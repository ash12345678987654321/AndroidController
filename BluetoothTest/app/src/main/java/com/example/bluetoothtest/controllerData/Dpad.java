...
public class Dpad {
    ...
    public String getUp(){ return btns[UP].getOutput(); }
    public String getDown(){ return btns[DOWN].getOutput(); }
    public String getLeft(){ return btns[LEFT].getOutput(); }
    public String getRight(){ return btns[DOWN].getOutput(); }
