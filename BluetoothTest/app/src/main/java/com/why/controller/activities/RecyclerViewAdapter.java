...
import com.why.controller.controllerData.Command;
import com.why.controller.controllerData.Delay;
import com.why.controller.controllerData.KeyStroke;
import com.why.controller.controllerData.Loop;
import com.why.controller.controllerData.Text;
...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.CustomViewHolder> {
    ...
    public void up() {
        ...
        if (((macro.get(selected).notSwappable() && macro.get(selected - 1).notSwappable() &&
                (macro.get(selected) instanceof Loop || macro.get(selected - 1) instanceof Loop) ||
